...
\\ \vspace{0.1cm}\exercice{Exercice 1} \includegraphics[scale=0.6]{/var/www/sacado/static/img/no_calculator.png} \vspace{0.2cm}Soit $x$ un r�el. �crire sous forme d'intervalle ou de r�union d'intervalles le plus grand ensemble auquel appartient $x$.
