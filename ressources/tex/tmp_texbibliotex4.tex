...
\begin{document}
\centerline{\bf Probabilités conditionnelles } \ \\ \textbf{Exercice. Appartenance à un ensemble.}    Dans chaque cas, trouver, lorsque cela est possible, le nombre $x$ qui remplit les critères suivants :
\begin{enumerate}
\item $x \in \Q$ et $x \not\in \Z$
\item $x \in \R$ et $x \not\in \N$. 
\end{enumerate}\textbf{Exercice. Logique.}    Les affirmations sont-elles vraies ou fausses ?
\begin{enumerate}
