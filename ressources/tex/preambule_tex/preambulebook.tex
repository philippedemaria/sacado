...
\rhead{\includegraphics[scale=1]{../preambule_tex/pageCours.jpg} }
\lhead{}%
...
\rhead{\includegraphics[scale=1]{../preambule_tex/pageAd.jpg} }
\lhead{}%
\headerGeneral{p/1234}
}
{\newpage}
...
\rhead{\includegraphics[scale=1]{../preambule_tex/pageParcoursu.jpg} }
\lhead{}%
\headerGeneral{p/1234}
}
{\newpage}
...
\rhead{\includegraphics[scale=1]{../preambule_tex/pageParcoursd.jpg} }
\lhead{}%
\headerGeneral{p/1234}
}
{\newpage}
...
\rhead{\includegraphics[scale=1]{../preambule_tex/pageParcourst.jpg} }
\lhead{}%
\headerGeneral{p/1234}
}
{\newpage}
...
\rhead{\includegraphics[scale=1]{../preambule_tex/pageAuto.jpg} }
\lhead{}%
\headerGeneral{p/1234}
}
{\newpage}
...
\rhead{\includegraphics[scale=1]{../preambule_tex/pageAlgo.jpg} }
\lhead{}%
\headerGeneral{p/1234}
}
{\newpage}
...
%%%%%%%%%%%%%%%%%%%%%%%% Condition pour la calculatrice
 ...
 \begin{tikzpicture}
  \node[minimum width=0.7cm]{\includegraphics[scale=0.5]{../preambule_tex/calculator.png} };
 \end{tikzpicture} 
 }{
 \ifthenelse{\equal{#2}{2}}{
 \begin{tikzpicture}
  \node[minimum width=0.7cm]{\includegraphics[scale=0.5]{../preambule/no_calculator.png} };
 \end{tikzpicture} 
 }{}
 }
 }
