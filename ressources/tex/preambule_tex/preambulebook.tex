...
\newcommand{\headerGeneral}[2]{ % intitulé, couleur, qrcode
\includegraphics[scale=1]{/var/www/sacado/ressources/tex/#1.jpg}
\begin{tikzpicture}[remember picture,overlay]
\coordinate(NO) at (-2,-3);
\coordinate(SW) at (22,-2);
\node[text width=6.2cm,font=\small] at (20.6,0.885) {\color{white} \begin{small}#2\end{small} } ; 
\end{tikzpicture}
\vspace{-1cm}
}
...
\rhead{  }
\lhead{}%
\headerGeneral{pageCours}{p/1234}
}
{\newpage}
...
\rhead{  }
\lhead{}%
\headerGeneral{pageParcoursu}{p/1234}
}
{\newpage}
...
\rhead{  }
\lhead{}%
\headerGeneral{pageParcoursd}{p/1234}
}
{\newpage}
...
\rhead{  }
\lhead{}%
\headerGeneral{pageParcourst}{p/1234}
}
{\newpage}
...
borderline north={1pt}{-0.25pt}{sacado_green,dotted},
fontupper={\color{sacado_green}}
        \fcolorbox{sacado_green}{sacado_green}{\color{white}{\small EXEMPLE}}
        \color{sacado_green}\vspace{1mm}
}
