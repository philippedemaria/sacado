...
\newcommand{\titreFiche}[1]{\centerline{\Ovalbox{\parbox[t]{0.7\textwidth}{
\vspace{-0.5em}\begin{center} \bf \large #1
\end{center}
\vspace{-0.5em}}}}

  \bigskip
\fancyfoot[L]{\includegraphics[height=1em]{logo.png}\textcolor{bleusad}{\textsf{\ \raisebox{2pt}{SACADO. {\tt https://sacado.xyz}}}}
\fancypagestyle{Page1}{\fancyhead{}\renewcommand{\headrulewidth}{0pt}}
\thispagestyle{Page1}
\fancyhead[L]{#1}
\fancyfoot[R]{P. \textsc{Demaria}}
