...
\vspace{-0.5em}}}}
  ...
  \bigskip
\fancyfoot[L]{\includegraphics[height=1em]{/var/www/sacado/static/img/sacadoA1.png}\textcolor{bleusad}{\textsf{\ \raisebox{2pt}{SACADO. {{\footnotesize https://sacado.xyz > #3}}}}}}
...
\vspace{0.2cm}
\tikz\node[rounded corners=5pt, fill=violet]{\color{white}\textbf{#1}};
}
