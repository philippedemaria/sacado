...
def ajax_search_bibliotex_by_level(request):
    ...
    base = Bibliotex.objects.filter(Q(teacher__user__school = teacher.user.school)| Q(teacher = teacher )| Q( author__user_id=teacher_id ) ,is_share = 1).exclude(teacher=teacher)
