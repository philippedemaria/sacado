...
urlpatterns = [
    ...
    path('parcours_organize/<int:id>/', organize_parcours, name='organize_parcours'),
    path('parcours_tasks_and_publishes/<int:id>/', parcours_tasks_and_publishes, name='parcours_tasks_and_publishes'),
    ...
    path('parcours_exercises/<int:id>/', parcours_exercises, name='parcours_exercises'),
    path('parcourses_all/', all_parcourses, name='all_parcourses'),

    path('parcours_clone/<int:id>/', clone_parcours, name='clone_parcours'),

    path('parcours_group/<int:id>/', list_parcours_group, name='list_parcours_group'),

    path('parcours_populate/<int:id>/', populate_parcours, name='populate_parcours'),
    ...
    path('create_remediation/<int:ide>/', create_remediation, name='create_remediation'),
    path('update_remediation/<int:ide>/<int:id>/', update_remediation, name='update_remediation'),
