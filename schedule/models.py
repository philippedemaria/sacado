...
class Event(models.Model):
    ...
    users = models.ManyToManyField(User, default='',  blank=True, related_name='event_with', related_query_name="event_with",   verbose_name="Partagée avec")
...
class Automatic(models.Model):
    user = models.ForeignKey(User, blank=True, related_name='user_automatic', on_delete=models.CASCADE) # La liaison OneToOne vers le modèle User2
