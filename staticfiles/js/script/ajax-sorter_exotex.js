define(['jquery', 'bootstrap', 'ui', 'ui_sortable'], function ($) {
    $(document).ready(function () {
        console.log("chargement JS ajax-sorter_exotex.js OK --");
        ...
        // sorter_supportfiles(  '#exotex_ranking' ,".this_exotex");
        
 
 
        $(document).on('blur' , '.sort_exotex' , function () {
