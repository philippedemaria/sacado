/********************************************************************************************
* R-Quiz - JavaScript-Framework for interactive quizzes Felix Riesterer (felix-riesterer.de)*
*********************************************************************************************/
	...
	var q = {
		...
		init: function () {
			...
			q.each(document.getElementsByTagName("script"), function (s) {
				...
				if (s.src && s.src.match(/\/all_quizzes.js\b/)) {
			...
			if (q.baseURL && h) {
				...
				l = h.appendChild(q.create({
					href: q.baseURL + "/css/all_quizzes.css",
					rel: "stylesheet",
					tagName: "link"
				}));
