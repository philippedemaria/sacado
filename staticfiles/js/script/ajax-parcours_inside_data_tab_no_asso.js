define(['jquery','bootstrap_popover', 'bootstrap' ], function ($) {
    $(document).ready(function () {
        ...
        $('.dataTables_length').append("  <a href='#' title='Version établissement requise' class='btn btn-default pull-right'><i class='bi bi-file-arrow-down'></i> compétences vers Pronote</a>  ") ;
