...
function runScript() {
    ...
    editor.container.childNodes[0].value = src ;
 ...
 * Hiding side by side.
 */
var button = document.getElementById("hide-console");
button.addEventListener("click", function (event) {
    var button = document.getElementById("hide-console");
    button.style.display = "none";
    button = document.getElementById("hide-editor");
    button.style.display = "";
    var elt = document.getElementById("right-div");
...
var button = document.getElementById("hide-editor");
button.addEventListener("click", function (event) {
    var button = document.getElementById("hide-editor");
    button.style.display = "none";
    button = document.getElementById("show-editor-console");
    button.style.display = "";
    var elt = document.getElementById("left-div");
    elt.style.display = "none";
...
var button = document.getElementById("show-editor-console");
button.addEventListener("click", function (event) {
    var button = document.getElementById("show-editor-console");
    button.style.display = "none";
