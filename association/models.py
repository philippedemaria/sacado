...
class Abonnement(models.Model):
    ...
    is_gar     = models.BooleanField(default=0, verbose_name="Usage du GAR", editable=False)
    is_active  = models.BooleanField(default=0, verbose_name="Actif", editable=False)
